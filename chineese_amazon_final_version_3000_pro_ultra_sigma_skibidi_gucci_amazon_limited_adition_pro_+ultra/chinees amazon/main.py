...
def user():
    if 'user' in flask_session:
        subjects = ['Westinghouse Outdoor Power Equipment', 'SAMSUNG Galaxy S24']
...
product1 = Products(Product_name='Westinghouse Outdoor Power Equipment ', 
 Product_owner='Mark Smith', price=150)
db_session.add(product1)
db_session.commit()

product2 = Products(Product_name='SAMSUNG Galaxy',
